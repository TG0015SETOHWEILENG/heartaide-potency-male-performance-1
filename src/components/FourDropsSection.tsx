    ...
    >
      <div className="mx-auto w-full max-w-5xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-10 md:gap-14 items-start mb-14">
          ...
          <ScrollReveal animation="scale-in" className="hidden md:flex flex-col items-center md:sticky md:top-24">
            <img
            ...
            <div className="mt-5 w-full max-w-[320px] rounded-xl bg-cta/15 border border-cta/30 p-4 text-center shadow-lg">
              <p className="font-heading text-[16px] text-foreground leading-snug font-bold">🔬 Doctor-Recommended Formula</p>
              <p className="font-body text-[13px] text-foreground/70 mt-1">Clinically studied ingredients</p>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-10 md:hidden">
          {[
            ...
            <ScrollReveal key={label} animation="fade-up" delay={i * 100}>
              <div className="rounded-xl bg-white border border-border p-4 text-center shadow-lg">
                <Icon className="w-6 h-6 text-cta mx-auto mb-1.5" strokeWidth={2} />
