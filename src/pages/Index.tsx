      ...
      <section className="section-padding bg-cover bg-right md:bg-center bg-no-repeat" style={{ backgroundImage: 'url(/images/stockup-bg.png)' }}>
        <div className="container-narrow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <ScrollReveal animation="scale-in" className="order-2 md:order-1">
              <img
      ...
      <Suspense fallback={null}>
        ...
        <section id="transformation" className="section-padding bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.55), rgba(0,0,0,0.65)), url('/images/transformation-bg.jpg')` }}>
          <div className="container-narrow text-center mb-8 md:mb-10">
            <ScrollReveal animation="fade-down">
              <h2 className="font-heading text-[28px] text-white leading-tight max-w-5xl mx-auto md:text-4xl capitalize">Choose the "6 Bottles" Package for Maximum Savings and Sexual Transformation!
